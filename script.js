...
const songs = [
  ...
  "Cardi B - Bodak Yellow", "Dennis Lloyd - Never Go Back", "Ed Sheeran - Galway Girl", "Ed Sheeran - The A Team", "Harry Styles - Lights Up", "Little Big - Uno", "Lizzo - Good As Hell", "Post Malone -Stay", "Toto - Africa", "Travis Scott - SICKO MODE ft. Drake", "Vance Joy - Fire and the Flood", "אביתר בנאי - כלום לא עצוב", "איתי לוי - קירות", "אליעד - מסע (אקוסטי)", "גידי גוב -בלעדייך", "הפרויקט של עידן רייכל - מנעי קולך מבכי", "חנן בן ארי - אלוף העולם", "חנן בן ארי - אם תרצי", "ישי ריבו - תוכו רצוף אהבה", "עדן חסון - שמישהו יעצור אותי", "עידן רייכל - גלגל מסתובב", "עידן רייכל - לפני שייגמר", "רביד פלוטניק - בור ועם הארץ (מארח את טונה)", "שירי מרפסת -ישראל", "שם טוב לוי, ואפרים שמיר - הידעת את הדרך", "Alice Merton - No Roots", "Alt-J  - Matilda", "Alt-J - Taro", "Bobby Brown - Every Little Step", "Fall Out Boy - HOLD ME TIGHT OR DON’T", "Feker Libi-עדן אלנה", "Fkj & Masego - Tadow", "Giant Heart - theAngelcy", "Lola Marsh - Only For A Moment", "LSD - Thunderclouds ft. Sia, Diplo, Labrint", "Mac Miller - Good News", "Michael Bublé - Haven't Met You Yet", "Michael Buble - Quando Quando", "Michael Kiwanuka - Cold Little Heart", "Simple Plan - Everything Sucks", "Skeeter Davis - The End of The World", "The Strokes - Bad Decisions", "אריק אניישטין-קילפתי תפוז", "בניה ברבי - במקום הכי רחוק", "ג׳יין בורדו - זה עוד לא אבוד", "רבות הדרכים - גרסת הקורונה", "הפרויקט של עידן רייכל - בקרוב", "הפרויקט של עידן רייכל - שושנים עצובות", "חנן בן ארי - מה אתה רוצה ממני", "יובל דיין - תשאל את המים", "ישי ריבו - מטבע הדברים", "עקיבא - פשוטים", "שלומי שבת ואליעד - מורידים את הירח", "Alice Merton - No Roots", "Arizona Zervas - ROXANNE", "Coco Jambo- Mr. President", "Doja Cat - Say So", "Fkj & Tom Misch - Losing My Way", "Full Trunk ft. Sivan Talmor - As a stone", "Golden Slumbers The End - The Beatles", "Jake Bugg - Broken", "Love & Hate -Michael Kiwanuka", "MIKA - Relax, Take It Easy", "Oasis - Wonderwall", "R.E.M. - Losing My Religion", "Red Hot Chili Peppers - Californication", "Red Hot Chili Peppers - Under The Bridge", "Rihanna - Love On The Brain", "Somewhere Over The Rainbow-Israel IZ", "Static & Ben El, Pitbull - Further Up", "TASH SULTANA - JUNGLE", "theAngelcy - The Call", "Train - 50 Ways To Say Goodbye", "בניה ברבי - מישהו איתי כאן", "הפרויקט של עידן רייכל - Todas las Palabras", "טונה - אוח (עם אחשתיים)", "עטר מיינר - פרפר (עם דור3 ועדן דרסו)", "עטר מיינר ויובל שם טוב - הדרך שלי", "קפה שחור חזק ואלון אולארצ'יק - בתוך ענייך", "רביד פלוטניק - נענע", "תומר יוסף - אל תטוסי"
